package com.frhnfath.myreadwritefile
...
import com.frhnfath.myreadwritefile.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun saveFile() {
        when {
            binding.editTitle.text.toString().isEmpty() -> Toast.makeText(this, "Title must be filled", Toast.LENGTH_SHORT).show()
            binding.editFile.text.toString().isEmpty() -> Toast.makeText(this, "File must be filled", Toast.LENGTH_SHORT).show()
            else -> {
