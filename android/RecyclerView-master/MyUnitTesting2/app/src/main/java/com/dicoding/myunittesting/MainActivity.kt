    ...
    override fun onClick(v: View) {
        ...
        when {
            TextUtils.isEmpty(length) -> {
                activityMainBinding.edtLength.error = "This Field Cannot be Empty"
            }
            TextUtils.isEmpty(width) -> {
                activityMainBinding.edtWidth.error = "This Field Cannot be Empty"
            }
            TextUtils.isEmpty(height) -> {
                activityMainBinding.edtHeight.error = "This Field Cannot be Empty"
            }
