...
import com.frhnfath.storyapp.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.captureIcon.setOnClickListener{ captureImage() }
        binding.flipIcon.setOnClickListener { startCamera() }
    }
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_CODE_PERMISSIONS) {
            if (!allPermissionsGranted()) {
                Toast.makeText(this, "Not getting permissions", Toast.LENGTH_SHORT).show()
                finish()
            }
        }
    }
