...
class MainActivityTest {
    ...
    fun assertGetCircumference() {
        ...
        onView(withId(R.id.btn_calculation_circumference)).check(matches(isDisplayed()))
        onView(withId(R.id.btn_calculation_circumference)).perform(click())
    ...
    fun assertGetVolume() {
        ...
        onView(withId(R.id.btn_save)).check(matches(isDisplayed()))
        onView(withId(R.id.btn_save)).perform(click())
        onView(withId(R.id.btn_calculation_volume)).check(matches(isDisplayed()))
        onView(withId(R.id.btn_calculation_volume)).perform(click())
        onView(withId(R.id.tv_result)).check(matches(isDisplayed()))
